...
- The repository containing the declarations of services to be tracked is named `$instance_name-declarations`. [Create it from a template](https://github.com/OpenTermsArchive/template-declarations)
- The repository containing the snapshots of the tracked documents (unless the instance is storing them in an alternative database) is named `$instance_name-snapshots`. [Create it from a template](https://github.com/OpenTermsArchive/template-snapshots)
- The repository containing the versions of the tracked documents (unless the instance is storing them in an alternative database) is named `$instance_name-versions`. [Create it from a template](https://github.com/OpenTermsArchive/template-versions)
