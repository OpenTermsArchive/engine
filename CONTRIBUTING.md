...
For non-functional changes (documentation, CI workflow…) that should not trigger a release, the following content should be added its entirety to the changelog:
```
