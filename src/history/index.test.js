...
const EXPECTED_SNAPSHOT_FILE_PATH = `${SNAPSHOTS_PATH}/${SERVICE_ID}/${TYPES.default[TYPE].fileName}.html`;

const VERSION_FILE_CONTENT = '# ToS fixture data with UTF-8 çhãràčtęrs';
const EXPECTED_VERSION_FILE_PATH = `${VERSIONS_PATH}/${SERVICE_ID}/${TYPES.default[TYPE].fileName}.md`;
