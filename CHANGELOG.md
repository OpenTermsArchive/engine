...
### Changed
- Test with MongoDB v6 instead of v5. The engine should still be compatible with v5, and should already have been compatible with v6.
- Test on Ubuntu 22.04 instead of 20.04.
